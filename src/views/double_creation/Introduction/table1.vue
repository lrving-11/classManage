      ...
      >
        ...
        <el-form-item label="所属学院">
          <!-- <el-input
            ...
            placeholder="姓名(学院)"
          ></el-input> -->
          <el-select v-model="form.classBelongCollege" placeholder="请选择">
            <el-option
        ...
        >
          ...
          <div style="text-align: right; margin: 0">
            ...
            <el-button
              type="primary"
              size="mini"
              @click="status === 'add' ? addIntroduce() : editIntroduce()"
              >确定</el-button
            >
          </div>
...
export default {
  ...
  methods: {
    ...
    deleteInfo(row, index) {
      ...
      deleteIntroduce(row.classId, this.adminUserName)
        .then((result) => {
          this.$notify({
            title: "成功",
            message: "删除成功",
    ...
    editIntroduce() {
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          editIntroduce("superAdmin", this.form)
            .then((res) => {
              this.findAllIntroduceInfo();
            })
            .catch((err) => {});
