                ...
                >
                    <el-row style="width: 100%; justify-content: space-between">
                        <el-form-item v-for="i in fields" :key="i.id">
                            <el-input v-model="i.chName" clearable></el-input>
                            <el-input v-model="i.engName" clearable></el-input>
                            <el-select
                                v-model="i.attribute"
                                clearable
...
import { getField, addField, deleteField } from "@/api/dontai";
        ...
        onSubmit() {
            ...
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    delete form.comField.doubleCreationClass;

                    addCreationStudent(form)
                        .then((res) => {
                            this.$message.success(res.msg);
